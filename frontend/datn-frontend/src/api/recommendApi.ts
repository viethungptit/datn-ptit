...
export const listRecommendBatches = (
  jobId: string,
  params?: { limit?: number }
) =>
  gatewayApi.get(`/api/recommend-service/recommend_batches/${jobId}`, {
    params,
  });
...
export const getRecommendedJob = (cv_ids: string[]) =>
  gatewayApi.post("/api/recommend-service/suggest_jobs", cv_ids);
