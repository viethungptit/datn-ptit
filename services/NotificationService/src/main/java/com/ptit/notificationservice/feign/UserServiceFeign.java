...
public interface UserServiceFeign {
    ...
    @GetMapping("/api/user-service/users/by-email/{email}")
    UserResponse getUserByEmail(@PathVariable("email") String email, @RequestHeader("X-Internal-Secret") String secret);
}
